...
use sp_runtime::traits::{
	BlakeTwo256, Block as BlockT, IdentityLookup, AccountIdLookup, Verify, IdentifyAccount, NumberFor,
};
...
//    pub MaximumSchedulerWeight: Weight = Perbill::from_percent(80) * MaximumBlockWeight::get();
    pub MaximumSchedulerWeight: Weight = Perbill::from_percent(80) * 2 * 1_000_000_000_000;
